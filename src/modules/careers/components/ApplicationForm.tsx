        ...
        <form onSubmit={handleSubmit} className="mt-10 p-6 sm:p-8 rounded-2xl bg-zinc-800/50 border border-white/[0.06] space-y-5">
          <div className="grid sm:grid-cols-2 gap-5">
            <label className="block">
              ...
              <input required type="text" className="mt-2 w-full h-11 px-4 bg-zinc-900 border border-white/10 rounded-lg text-white text-sm transition-all focus:outline-none focus:border-gold/50" placeholder="Nguyễn Văn A"/>
            </label>
            <label className="block">
              <span className="text-[10px] uppercase tracking-[0.18em] text-zinc-400 font-semibold">Số điện thoại</span>
              <input required type="tel" className="mt-2 w-full h-11 px-4 bg-zinc-900 border border-white/10 rounded-lg text-white text-sm transition-all focus:outline-none focus:border-gold/50" placeholder="0947 947 168"/>
            </label>
          </div>
          <label className="block">
          ...
          <label className="block">
            ...
            <textarea rows={4} className="mt-2 w-full p-4 bg-zinc-900 border border-white/10 rounded-lg text-white text-sm resize-none transition-all focus:outline-none focus:border-gold/50" placeholder="Kinh nghiệm, kỹ năng, mong muốn..."/>
          </label>
          <label className="flex items-center gap-3 px-4 h-14 bg-zinc-900 border border-dashed border-white/15 rounded-lg cursor-pointer hover:border-gold/50 transition-all">
