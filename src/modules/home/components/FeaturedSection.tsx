...
// Maps content JSON slot keys to featured array indices
const FEATURED_SLOT_KEYS = ['feat-cat', 'feat-uon', 'feat-nhuom']
...
export default function FeaturedSection() {
  ...
  const featured = data.featured.map((item, i) => {
    const slotKey = FEATURED_SLOT_KEYS[i]
