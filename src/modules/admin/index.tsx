  ...
  return (
    <div className="h-screen bg-zinc-950 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        {view.type === 'library' ? (
          <MediaLibrary onBack={() => setView({ type: 'overview' })} />
        ) : view.type === 'page' ? (
          <PageDetail
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="max-w-5xl mx-auto px-5 sm:px-7 py-6">
              ...
              <div className="mt-4 p-4 bg-zinc-900/50 border border-white/8 rounded-2xl text-xs text-zinc-500 space-y-1">
                <p>☁️ <strong className="text-zinc-400">Lưu trữ:</strong> Cloudflare R2 — tốc độ cao, phân phối toàn cầu</p>
