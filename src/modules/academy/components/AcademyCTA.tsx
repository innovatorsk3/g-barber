  ...
  return (
    <section className="px-5 sm:px-8 pb-20">
      <div className="max-w-6xl mx-auto relative overflow-hidden rounded-3xl bg-zinc-800 border border-white/[0.06]">
        <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage: 'url(assets/gallery/nhuom-bach-kim.jpg)', filter: 'grayscale(40%)' }}/>
        ...
        <div className="relative px-6 sm:px-12 py-12 sm:py-16 max-w-2xl">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Btn as="a" href="tel:0947947168" icon={<Phone size={12}/>}>Tư vấn miễn phí</Btn>
          </div>
        </div>
      </div>
    </section>
