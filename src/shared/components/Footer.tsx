        ...
        <div className="md:col-span-5">
          ...
          <div className="mt-6 flex gap-2 flex-wrap">
            {['Facebook', 'Instagram', 'TikTok', 'YouTube'].map(s => (
              <a key={s} href="#" className="text-[11px] uppercase tracking-[0.12em] text-zinc-300 border border-white/10 hover:border-brand hover:text-white hover:bg-brand/10 rounded-full px-3.5 py-2 transition-all">
                {s}
              </a>
            ))}
          </div>
